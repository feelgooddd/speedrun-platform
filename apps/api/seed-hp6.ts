...
const SRDC_HP6_PC_GAME_ID = "xv1p4m18";
const SRDC_HP6_DS_GAME_ID = "o1yypv1q";
...
const PC_CATEGORIES = [
  { srdcId: "5dwp4ekg", name: "Any%", slug: "any" },
  { srdcId: "q258j8j2", name: "100%", slug: "100" },
  { srdcId: "xd17168d", name: "All Crests", slug: "all-crests" },
];

const DS_CATEGORIES = [
  { srdcId: "zd3045nd", name: "Any%", slug: "any" },
  { srdcId: "9d830w62", name: "100%", slug: "100" },
];
...
// ============================================================
// SEED RUNS (flat — no variable filtering)
// ============================================================
