      ...
      <div className="auth-card">
        ...
        <div className="auth-header">
          ...
          <p className="auth-subtitle">
            {step === "verify"
              ? "Verify your speedrun.com account"
              : step === "claim"
              ? "Almost there! Set your credentials"
              : "Join the wizarding speedrun community"}
          </p>
        </div>
        ...
        {step === "verify" && (
          <div className="auth-form">
            <p style={{ marginBottom: "1rem", fontSize: "0.9rem", opacity: 0.8 }}>
              The username <strong>{form.username}</strong> exists in our database from speedrun.com. To claim it, enter your speedrun.com API key.
            </p>
            <div className="auth-field">
            ...
            <button
              ...
              onClick={() => { setApiKey(""); setStep("form"); }}
            >
        ...
        {step === "claim" && (
          <form onSubmit={handleSubmit} className="auth-form">
            <p style={{ marginBottom: "1rem", fontSize: "0.9rem", color: "#4ade80" }}>
              ✓ API key entered. Set your email and password to claim your account.
            </p>
            <div className="auth-field">
              <label className="auth-label">Email</label>
              <input
